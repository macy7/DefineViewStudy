 ...
 * @Package: com.mcy.define
 * @ClassName: AndroidSurfaceView
 * @Description: java类作用描述
 * @Author: macy
 * @CreateDate: 2020/5/3 8:01
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/5/3 8:01
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class AndroidSurfaceView extends SurfaceView implements Runnable, SurfaceHolder.Callback {
